 ...
 * This page shows the signature workflow and renders that DOCX to PDF with a
 * document-compatible renderer (Microsoft Word) for on-screen review; the
 * DOCX download remains the authoritative deliverable.
 */
